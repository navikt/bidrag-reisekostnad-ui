...
export default function TokenInput({isDevelopment}: {isDevelopment?: boolean}): ReactElement | null {
  ...
  return (
      ...
      >
        ...
        <div>
          ...
          <a href="https://bidrag-reisekostnad.dev.nav.no/api/session">https://bidrag-reisekostnad.dev.nav.no/api/session</a>{" "}
        </div>
