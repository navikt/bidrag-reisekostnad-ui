            ...
            {(() => {
                switch (status) {
                    case ForesporselStatus.VENTER_PAA_SAMTYKKE_FRA_DEG:
                        return (
                            <Tag data-color="warning" variant="outline" size="small" className="mt-3">
                    ...
                    case ForesporselStatus.KANSELLERT:
                        return (
                            <Tag data-color="neutral" variant="outline" size="small" className="mt-3">
                                {translate('status.kansellert')}
                            </Tag>
                        );
                    default:
                        return (
                            <Tag data-color="success" variant="outline" size="small" className="mt-3">
