    ...
    <>
      ...
      <div className="flex flex-col gap-12 items-center">
        ...
        <Alert variant="warning">
          ...
          reisekostnader.
          <br></br>
          Du bør gjøre motparten oppmerksom på dette. Hvis motparten ikke har signert innen tre
          dager vil vi sende han en påminnelse per sms.
        </Alert>
        <div className="flex flex-col gap-5">
          <BodyShort spacing>
            {" "}
            Du kan gjenfinne forerspørselen om reisekostnader her: lenke
          </BodyShort>
          <BodyShort className="leading-relaxed" spacing>
          ...
          <BodyShort className="leading-relaxed" spacing>
            Det bør ikke opprettes et nytt forerspørsel for samme barn før motparten har signert
            eller den forerspørselen skal slettes.
          </BodyShort>
        </div>
      </div>
    </>
